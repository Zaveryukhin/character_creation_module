...
def start_training(character: Character):
    phrases_and_commands = {'Warrior': f'{character.name}, ты Воитель — великий мастер ближнего боя.',
    ...
    print(phrases_and_commands[character.__class__.__name__])
    ...
    while cmd != 'skip':
        ...
        print(phrases_and_commands[cmd])
